...
- **LIGO-Virgo-Kagra (LVK)** — Ground-based gravitational-wave detection 💫
- **Einstein Telescope (ET)** — Next-generation gravitational-wave observatory
- **Société Astronomique de Bourgogne (SAB)** — Astronomy outreach and education
...
- 🔗 [GitHub](https://github.com/jperret21) — Explore my open-source code and projects
- 🏛️ [APC Laboratory](https://apc.u-paris.fr/APC_CS/) — Research group and collaborations
- 📧 Contact me for collaborations, questions, or speaking opportunities
